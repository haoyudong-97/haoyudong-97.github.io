...
\newcommand{\bullets}{\begin{itemize}[leftmargin=0.18in,topsep=3pt,itemsep=4pt,parsep=0pt,partopsep=0pt]}
\newcommand{\finishbullets}{\end{itemize}\vspace{2pt}}
...
\begin{center}
  ...
  \href{mailto:jerrydong0330@gmail.com}{jerrydong0330@gmail.com} $\vert$
  +1 858 500-2825 $\vert$
...
Ph.D. candidate in Electrical \& Computer Engineering at Duke University, specializing in foundation models, LLM agents, multimodal learning, and data-centric AI. Industry research experience at Meta and Siemens Healthineers, developing algorithm-evolution methods for LLM agents and in-context learning systems for 3D medical image segmentation. Author of 33 research works in medical AI, computer vision, and multimodal learning.

\section{Industry Experience}
\entry{Meta}{May 2026 -- Sep. 2026}{Software Engineer Intern}{Menlo Park, CA}
\bullets
  \item Developed branching search for recursive self-improvement of LLM agent harnesses, evolving development objectives and proposal policies from execution feedback to discover complementary reasoning and coding strategies.
  \item Built a router to select among complementary harnesses, achieving relative gains over Meta-Harness of \textbf{34.8\%} on Olympiad-level math, \textbf{11.6\%} on Terminal-Bench 2.0, and \textbf{3.8\%} on SWE-bench Lite; selected all harnesses using development data alone.
\finishbullets

\entry{Siemens Healthineers}{Jun. 2025 -- Aug. 2025}{AI Research Intern}{Princeton, NJ}
\bullets
  \item Developed a 3D nnU-Net in-context segmentation framework with multi-stage cross-attention, reaching \textbf{52.1\% Dice} on held-out unseen anatomies versus \textbf{36.7\%} for the strongest prior ICL baseline, without retraining for new tasks.
  \item Curated \textbf{14,934 CT volumes} spanning \textbf{92 anatomical structures}; conducted the first systematic 3D support-selection study, revealing a \textbf{21-point Dice} range.
  \item \textbf{Co-inventor of patent-pending technology} for 3D in-context segmentation, assigned to Siemens Medical Solutions USA, Inc.
\finishbullets

\entry{Gradient Health}{May 2020 -- Sep. 2020}{Fellowship Recipient}{Durham, NC}
\bullets
  \item Built a private multimodal dataset of diagnostic images and paired radiology reports from \textbf{2.6M patients}; developed a language-informed BYOL pretraining pipeline that improved accuracy by \textbf{3\% (absolute)} over a ResNet baseline.
\finishbullets
...
\begin{itemize}[leftmargin=0.18in,topsep=2pt,itemsep=4pt,parsep=0pt]
  \pub{\textbf{Haoyu Dong}, Han Liu, Riqiang Gao, Bogdan Georgescu, Guillaume Chabin, Jianing Wang, and Sasa Grbi\'c. ``Revisiting In-Context Learning for 3D CT Segmentation of Unseen Anatomies.'' \textit{In submission}.}
  \pub{\textbf{Haoyu Dong}, Yuhang Zhou, Zihao Lin, Yifan Wu, Bo Peng, Mingyi Wang, Xiangjun Fan, Lizhu Zhang, and Zhuokai Zhao. ``Branching Search with Evolving Objectives and Policies for Agent Harness Optimization.'' \textit{In submission}.}
  \pub{Zihao Lin, \textbf{Haoyu Dong}, Haobo Xu, Chi-Chih Chang, Xuying Ning, Yinglong Xia, Shuang Yang, Zhuokai Zhao, Xinying Song, Lifu Huang, Yang Song, and Qifan Wang. ``VideoHarness-RSE: Recursive Structured Evolution of Harnesses for Video Understanding.'' \textit{In submission}.}
  \pub{Hanxue Gu*, \textbf{Haoyu Dong*}, Pedro R. A. S. Bassi, Wenxuan Li, Alan Yuille, Zongwei Zhou, Kang Wang, and Yang Yang. ``Reports Are Not Captions: Understanding and Designing Report Supervision for Label-Efficient 3D Lesion Segmentation.'' \textit{In submission}.}
  ...
  \pub{Yuheng Li, Yuan Gao, \textbf{Haoyu Dong}, Yuxiang Lai, Shansong Wang, Mojtaba Safari, James E. Baciak, and Xiaofeng Yang. ``Universal CT Representations from Anatomy to Disease Phenotype through Stage-wise Pretraining.'' \textit{npj Digital Medicine}, 2026.}
...
\section{Education}
\entry{Duke University}{Expected May 2027}{Ph.D., Electrical \& Computer Engineering}{Durham, NC}
\vspace{6pt}
...
\textbf{Area Chair:} \href{https://genai4health.github.io/2026-NeurIPS/}{GenAI4Health Workshop at NeurIPS 2026}\\[2pt]
