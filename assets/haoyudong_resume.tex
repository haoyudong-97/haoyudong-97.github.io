...
\begin{itemize}[leftmargin=0.18in,topsep=2pt,itemsep=4pt,parsep=0pt]
  ...
  \pub{\textbf{Haoyu Dong}, Han Liu, Riqiang Gao, Bogdan Georgescu, Guillaume Chabin, Jianing Wang, and Sasa Grbi\'c. ``Revisiting In-Context Learning for 3D CT Segmentation of Unseen Anatomies.'' \textit{Under review}.}
\end{itemize}
\newpage
