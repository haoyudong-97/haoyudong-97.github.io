...
\bullets
  ...
  \item Curated \textbf{14,934 CT volumes} spanning \textbf{92 anatomical structures}; conducted the first systematic 3D support-selection study, revealing a \textbf{21-point Dice} range. Co-inventor on the resulting \textbf{patent-pending} technology assigned to Siemens Medical Solutions USA, Inc.
\finishbullets
